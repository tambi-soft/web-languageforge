...
angular.module('webtypesetting', ['ui.router', 'webtypesetting.projectSetup', 'bellows.filters', 'webtypesetting.composition', 'webtypesetting.discussionList', 'webtypesetting.discussionThread', 'webtypesetting.services', 'webtypesetting.projectSetupLayout', 'webtypesetting.projectSetupAssets', 'webtypesetting.renderList']).run(['$rootScope', '$state', '$stateParams', function($rootScope, $state, $stateParams) {
