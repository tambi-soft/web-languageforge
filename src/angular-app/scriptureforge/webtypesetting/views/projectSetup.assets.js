...
.controller('projectSetupAssetsCtrl', ['$scope', '$state', '$upload', 'typesettingAssetService', 'sessionService', 'modalService', 'silNoticeService'/*, 'breadcrumbService'*/,
                                       function($scope, $state, $upload, typesettingAssetService, sessionService, modal, notice/*, breadcrumbService*/) {
